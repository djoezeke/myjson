...
namespace json
{
    ...
    enum class Error
    {
        ...
        INVALID_JSON,       //!< Occurs if a JSON is not valid.
...
#pragma region json
    ...
    public:
        // Methods for ordinary JSON object.
         ...
         * @code
         * json::JSON jsonObject(json::Type::STRING);
         * bool isString = jsonObject.IsString();
         * @endcode
         */
        bool IsString() const;
         ...
         * @code
         * json::JSON jsonNull(json::Type::NONE);
         * bool isNull = jsonNull.IsNone();
         * @endcode
         */
        bool IsNone() const;
    ...
    public:
        // Methods for JSON objects and JSON arrays
    ...
    private:
        ...
        //!< The array elements.
        mutable std::unordered_map<unsigned int, JSON *> m_Array;

        //!< The object elements.
        mutable std::unordered_map<std::string, JSON *> m_Object;
    };
